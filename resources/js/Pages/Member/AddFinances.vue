    ...
    <AuthenticatedLayout>
        <div class="tw-min-h-screen tw-bg-gray-50 tw-p-4">
            <div class="tw-flex tw-items-center tw-gap-2 tw-mb-4">
                <van-icon
                    name="arrow-left"
                    @click="$inertia.visit('/member/finances')"
                />
                <h2 class="tw-text-lg tw-font-semibold tw-text-center">
                    {{ title }}
                </h2>
            </div>

            <div class="tw-bg-white tw-rounded-2xl tw-p-5 tw-shadow-md">
                <div class="tw-text-gray-700 tw-font-medium tw-mb-2">
                    Nominal Simpanan
                </div>
                ...
                <div
                    v-if="!isWajib"
                    class="tw-grid tw-grid-cols-3 tw-gap-2 tw-mb-4"
                >
                    <van-button
