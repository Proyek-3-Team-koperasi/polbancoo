...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="tw-py-6 tw-px-6 tw-bg-white tw-rounded-md">
            <Form :action=" intent == 'edit' ? route('admin.products.update', product?.id || '3') : route('admin.products.store') "  method="POST" >
                ...
                <div class="tw-my-4 tw-col-span-full">
                    ...
                    <div class="tw-mt-2 tw-flex tw-justify-center tw-rounded-lg tw-border tw-border-dashed tw-border-black/25 tw-px-6 tw-py-10">
                        <div class="tw-text-center ">
                            ...
                            <div class="tw-mt-4 tw-flex tw-text-sm/6 tw-text-gray-400 tw-justify-center ">
                                ...
                                class="tw-relative tw-cursor-pointer tw-rounded-md tw-bg-transparent tw-font-semibold tw-text-indigo-400 tw-focus-within:outline-2 tw-focus-within:outline-offset-2 tw-focus-within:outline-indigo-500 tw-hover:text-indigo-300  ">
                                    ...
                                    <input id="file-upload" type="file" name="file-upload" class="tw-sr-only" @change="handleFileChange" accept="image/*" />
                                </label>
                            </div>
                ...
                <div class="tw-my-4" >
                    <Label for="cash_price">Harga Beli</Label>
                     ...
                     <FormattedNumberInput id="cash_price" placeholder="10000" />
                </div>

                <div class="tw-my-4" >
                    <Label for="cost_price">Harga Jual</Label>
                    <FormattedNumberInput id="cost_price" placeholder="12000" type="number"  />
                </div>

                <div class="tw-my-4" >
                    <Label for="cash_price">Stok</Label>
                    <Input id="cost_price" placeholder="5" type="number" />
                </div>
