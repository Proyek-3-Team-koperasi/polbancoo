...
<template>
  <CalendarRoot
    ...
    v-bind="forwarded"
    :class="cn('tw-rounded-md', props.class)"
  >
    <CalendarHeader>
      <CalendarHeading class="tw-flex tw-w-full tw-items-center tw-justify-between tw-gap-2">
        <Select
        ...
        >
          ...
          <SelectContent class="tw-max-h-[200px]">
            <SelectItem
        ...
        >
          <SelectTrigger aria-label="Select year" class="tw-w-[40%]">
    ...
    <div class="tw-flex tw-flex-col tw-space-y-4 tw-pt-4 tw-sm:flex-row tw-sm:gap-x-4 tw-sm:gap-y-0">
      <CalendarGrid v-for="month in grid" :key="month.value.toString()">
        ...
        <CalendarGridBody class="tw-grid">
