...
class CheckoutCashController extends Controller
{
    private const SESSION_KEY = 'member.checkout.cash.payload';

    public function __invoke(Request $request): Response
    {
        $payload = $this->resolvePayload($request);

        return Inertia::render('Member/CheckoutCash', $payload);
    }
    ...
    private function buildPayloadFromRequest(Request $request): array
    {
        ...
        return [
            ...
            'estimatedPoints' => (int) $request->input('estimatedPoints', 0),
